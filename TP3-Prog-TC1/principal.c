...
int main() {
	...
	do{
		...
		case 2:
			...
			scanf("%d", &opc);
			switch(opc){
			case 1: addStr(&C1, cad); deleteRep(C1); break;
			case 2: addStr(&C2, cad); deleteRep(C2); break;
			default: printf("\nOpcion invalida");
			}
			printf("\nProceso finalizado\n");
			break;
		...
		case 7:
			...
			break;
		case 8:
			if(searchSet(C2, C1)) printf("\nEl conjunto C2 no esta contenido en C1\n");
			else printf("\nEl conjunto C2 si esta contenido en C1\n");
			break;
		case 0:
			printf("\nFin del programa");
			break;
